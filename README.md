...
2. Descargar e instalar Ubuntu LTS (amd64).
  a. Importante indicarle 4GiB de memoria RAM y 1 CPU core.
  b. Configurarlo con 128 MB de memoria gráfica.
c. Configurar usuario y contraseña con el valor "nube" (sin comillas dobles)
...
8. Configurar usuario: sudo adduser nube vboxsf
   a. Con esto ya podremos compartir carpetas entre el host y el guest.
